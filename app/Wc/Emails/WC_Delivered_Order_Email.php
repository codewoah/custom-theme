...
class WC_Delivered_Order_Email extends \WC_Email {
    public function __construct() {
        ...
        $this->heading = 'Delivered,Order';
        $this->subject = get_field('delivered_email_subject','option');


        // these define the locations of the templates that this email should use, we'll just use the new order template since this email is similar
        $this->template_html  = 'emails/delivered-email-notification.blade.php';
