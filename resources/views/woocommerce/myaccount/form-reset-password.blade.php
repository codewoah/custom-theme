...
<?php do_action( 'woocommerce_before_reset_password_form' ); ?>
  <p><?php echo apply_filters( 'woocommerce_reset_password_message', sprintf( __( 'Enter a new password for your account <br /> %s', 'woocommerce' ) , $args['login'] ) ); ?></p><?php // @codingStandardsIgnoreLine ?>

  <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
    <input placeholder="Password" type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password_1" id="password_1" autocomplete="new-password" />
  </p>
