...
<form id="add_payment_method" method="post">
  <div id="payment" class="woocommerce-Payment">
    <ul class="woocommerce-PaymentMethods payment_methods methods">
      ...
      ?>
      <li style="display:block" class="woocommerce-PaymentMethod woocommerce-PaymentMethod--<?php echo esc_attr( $gateway->id ); ?> payment_method_<?php echo esc_attr( $gateway->id ); ?>">
        ...
        if ( $gateway->has_fields() || $gateway->get_description() ) {
          ...
          $gateway->description = '<p>Custom info</p>';
    ...
    <div class="form-row">
      ...
      <button type="submit" class="woocommerce-Button woocommerce-Button--alt button alt" id="place_order" value="<?php esc_attr_e( 'Add card', 'woocommerce' ); ?>"><?php esc_html_e( 'Add card', 'woocommerce' ); ?></button>
